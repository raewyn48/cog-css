...
(function ($) {
  ...
  $(document).ready(function(){
      ...
      $('#block-views-cognition-staff-block-2 .view-content').cycle({
        fx: 'fade',
        next: '.views-row #next-team-member',
        easing: 'swing',
        pause: true,
        continuous: 0,
        speedIn: 500,
    ...
    $('#block-views-cognition-staff-block-2 .view-content').cycle('pause');

    // Home pages and Programme pages slider
    $('.view-id-home_page_slider .field-content').cycle({
        speed:    400,
        timeout:  8000,
        random: true,
        prev:  '#cprev',
